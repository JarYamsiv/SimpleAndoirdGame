...
/**
 * Created by vismay on 2/24/2017.
 */

public class Health_Bar
{
    private float x=60,y=60,ex,h=100;
    private Drawing_Class drawing_class;
    private int width,height;

    public Health_Bar(int width, int height, Drawing_Class drawing_class)
    {
    ...
    public void fn_Draw(Canvas canvas)
    {
        ...
        paint.setColor(Color.rgb(243,36,36));
